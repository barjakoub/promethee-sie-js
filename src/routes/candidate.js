            ...
            connection.query(`SELECT rankId FROM promethee_results WHERE resultId='${resultId}'`, (error, results, fields) => {
                ...
                connection.query(`SELECT * FROM candidates WHERE rankId='${rankId}'`, (error, results, fields) => {
                    ...
                    for (let candidate of results) {
                        ...
                        _LEAVING_FLOWS.push((1 / 6) * _LEAVING_FLOW);
                    ...
                    for (let [index, _FINAL] of _FINAL_PREFERENSIS.entries()) {
                        if (index == 0) {
                            let K1 = (1 / 6) * (_FINAL_PREFERENSIS[1][index] + _FINAL_PREFERENSIS[2][index] + _FINAL_PREFERENSIS[3][index] + _FINAL_PREFERENSIS[4][index]);
                            _ENTERING_FLOWS.push(K1);
                        } else if (index == 1) {
                            let K2 = (1 / 6) * (_FINAL_PREFERENSIS[0][0] + _FINAL_PREFERENSIS[2][index] + _FINAL_PREFERENSIS[3][index] + _FINAL_PREFERENSIS[4][index]);
                            _ENTERING_FLOWS.push(K2);
                        } else if (index == 2) {
                            let K3 = (1 / 6) * (_FINAL_PREFERENSIS[0][1] + _FINAL_PREFERENSIS[1][index] + _FINAL_PREFERENSIS[3][index] + _FINAL_PREFERENSIS[4][index]);
                            _ENTERING_FLOWS.push(K3);
                        } else if (index == 3) {
                            let K4 = (1 / 6) * (_FINAL_PREFERENSIS[0][index - 1] + _FINAL_PREFERENSIS[1][index - 1] + _FINAL_PREFERENSIS[2][index - 1] + _FINAL_PREFERENSIS[4][index]);
                            _ENTERING_FLOWS.push(K4);
                        } else if (index == 4) {
                            let K5 = (1 / 6) * (_FINAL_PREFERENSIS[0][index - 1] + _FINAL_PREFERENSIS[1][index - 1] + _FINAL_PREFERENSIS[2][index - 1] + _FINAL_PREFERENSIS[3][index - 1]);
                    ...
                    for (let index = 0; index < _LEAVING_FLOWS.length; index++) {
                        let _NET_FLOW = _LEAVING_FLOWS[index] - _ENTERING_FLOWS[index];
